...
import { EnvironmentSniffer } from './environment-sniffer';

export class Environment {
  static get IS_TEST(): boolean {
    return EnvironmentSniffer.IS_TEST;
  }

  static get IS_DOCKER(): boolean {
    return EnvironmentSniffer.IS_DOCKER;
  }

  static get IS_LOCAL(): boolean {
    return EnvironmentSniffer.IS_LOCAL;
  }

  static get IS_PRODUCTION(): boolean {
    return EnvironmentSniffer.IS_PRODUCTION;
  }

  static get APP_SECRET(): string {
    return process.env[EnvironmentConstants.variables.appSecret];
  }
